...
from pytools.utils import pareto_frontier
...
algos = ['rf-rp', 'rf-kd', 'rf-pca', 'rf-class-depth']
algonames = {'rp': 'RP', 'rf-rp': 'RF-RP', 'rf-class-depth': 'RF-CLASS',
             'rf-kd' : 'RF-KD', 'rf-pca' : 'RF-PCA', 'kd' : 'KD', 'pca' : 'PCA'}
colors = ['#3182bd', '#31a354', '#e6550d', '#756bb1']
linestyles = ['dashed', 'dashdot', (0, (3, 1, 1, 1, 1, 1)), 'solid']
linewidths = [3, 3, 3, 3]
